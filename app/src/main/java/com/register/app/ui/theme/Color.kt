...
val BackgroundLight = Color(0xFFFDFCFC)
val BackgroundDark = Color(0xFF070707)
val SurfaceLight = Color(0xFFF8EEED)
val SurfaceDark = Color(0xFF3D3D3D)
val PrimaryLight = Color(0xFF6E0603)
val PrimaryDark = Color(0xFF6E0603)
val Translucent = Color(0xFFECECEC)
val BlackTranslucent = Color(0x80CCCCCC)
